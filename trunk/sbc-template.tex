...
O teste de carga com a ferramenta Activiti fortaleceu a ideia de que o teste de carga pode ser muito dependente do BPMS já que, dependendo da ferramenta, pode ser muito trabalhoso executar o teste, pode não ser possível executar o teste ou ainda pode ser possível e vantajoso, como ocorreu com o Bonita Open Solution. O BPMS deve ser avaliado antes da execução do teste para verificar se este é vantajoso ou não

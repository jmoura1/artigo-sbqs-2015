...
%Este teste foi escolhido pois um dos problemas encontrados durante a implantação do processo testado foi a falha do sistema perante um grande acesso de usuários em um dia específico. Acredita-se que, utilizando um teste de carga, esta falha poderia ter sido prevista.
...
Informações gerais sobre os testes &   Foram executados testes simulando 1,50,100 e 200 usuários virtuais; Os testes foram executados na etapa de login e na execução da primeira tarefa do processo;
 &  \\\hline
BPMS Bonita Open Solution (BOS) & \begin{itemize}\item{Houveram problemas com a execução de requisições que utilizavam a tecnologia Google Web Toolkit (GWT);}
...
Activiti & Community & Sim \\\hline
Intalio & Community e Enterprise & Sim \\\hline
Tibco & Licença de desenvolvedor por 90 dias & Não \\\hline
Bonita Open Solution & Community & Sim \\\hline
\end{tabular}
